...
class JobSearchService:
    ...
    async def get_linkedin_posts(role: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        """
        all_posts = [
            # AI / ML ENGINEER RECRUITER POSTS
            {
                "id": "lkd_post_101",
                "role_category": "AI/ML Engineer",
            ...
            # SOFTWARE ENGINEER / BACKEND RECRUITER POSTS
            {
                "id": "lkd_post_201",
                "role_category": "Software Engineer",
            ...
            },
            {
                ...
                "author_role": "Senior Tech Recruiter @ Flipkart",
                "author_avatar": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
                "company": "Flipkart",
                "post_text": "Flipkart Backend Engineering team is hiring software engineers for core e-commerce order management microservices in Java & Python. Check out our official LinkedIn hiring page!",
                "tags": ["Java", "Kafka", "PostgreSQL", "Bengaluru"],
                "linkedin_url": "https://www.linkedin.com/company/flipkart/jobs/",
                "posted_time": "3 days ago on LinkedIn",
                "verified": True
            },

            # DATA SCIENTIST RECRUITER POSTS
            {
                "id": "lkd_post_301",
                "role_category": "Data Scientist",
