...
ROLE_CATALOG: dict[str, dict[str, object]] = {
    ...
    "Forward Deployed Engineer": {
        "required_skills": ["Python", "FastAPI", "LangChain", "RAG", "Docker", "Kubernetes", "GCP", "SQL", "System Design"],
        "preferred_skills": ["Client Integration", "Enterprise Security", "Cloud Architecture"],
        "tools": ["Git", "Docker", "Kubernetes", "PostgreSQL", "Google Cloud"],
        "frameworks": ["FastAPI", "LangChain", "PyTorch"],
        "certifications": ["Google Professional Cloud Architect", "AWS Solutions Architect"],
        "difficulty": "expert",
        "estimated_learning_weeks": 36,
    },
    "AI Solutions Architect": {
        "required_skills": ["Python", "LangChain", "LangGraph", "OpenAI", "AWS", "GCP", "System Design", "Vector Databases"],
        "preferred_skills": ["Multi-Agent Orchestration", "Enterprise Security", "Cost Optimization"],
        "tools": ["Pinecone", "Qdrant", "Docker", "Kubernetes", "Terraform"],
        "frameworks": ["LangChain", "LangGraph", "FastAPI"],
        "certifications": ["AWS Certified AI Practitioner", "Google Cloud ML Engineer"],
        "difficulty": "expert",
        "estimated_learning_weeks": 34,
    },
    "MLOps Engineer": {
        "required_skills": ["Python", "MLflow", "Docker", "Kubernetes", "Airflow", "PyTorch", "CI/CD", "Cloud"],
        "preferred_skills": ["Model Monitoring", "Feature Stores", "Kubeflow"],
        "tools": ["MLflow", "Airflow", "Kubeflow", "Docker", "Prometheus"],
        "frameworks": ["PyTorch", "TensorFlow", "Scikit-learn"],
        "certifications": ["Certified Kubernetes Administrator (CKA)", "AWS Machine Learning Specialty"],
        "difficulty": "advanced",
        "estimated_learning_weeks": 28,
    },
    "Site Reliability Engineer (SRE)": {
        "required_skills": ["Linux", "Go", "Python", "Kubernetes", "Terraform", "Prometheus", "Grafana", "Networking", "System Design"],
        "preferred_skills": ["Chaos Engineering", "Incident Response", "SLO/SLA Management"],
        "tools": ["Prometheus", "Grafana", "Kubernetes", "Terraform", "GitOps"],
        "frameworks": ["Helm", "OpenTelemetry"],
        "certifications": ["Google Professional Cloud DevOps Engineer", "CKA"],
        "difficulty": "advanced",
        "estimated_learning_weeks": 30,
    },
    "LLM Systems Specialist": {
        "required_skills": ["Python", "PyTorch", "Transformers", "PEFT", "vLLM", "LangChain", "Vector Databases"],
        "preferred_skills": ["Quantization", "DeepSpeed", "RLHF Fine-Tuning"],
        "tools": ["HuggingFace", "vLLM", "DeepSpeed", "Pinecone"],
    ...
    "Staff Software Engineer": {
        "required_skills": ["System Design", "Microservices", "Python", "Go", "Java", "SQL", "PostgreSQL", "Redis", "Kafka"],
        "preferred_skills": ["Distributed Consensus", "Engineering Leadership", "High Scale Systems"],
        "tools": ["Kafka", "Redis", "Docker", "Kubernetes", "PostgreSQL"],
        "frameworks": ["FastAPI", "Spring Boot", "gRPC"],
        "certifications": ["AWS Solutions Architect Professional"],
        "difficulty": "expert",
        "estimated_learning_weeks": 40,
    },
    "Platform Engineer": {
        "required_skills": ["Go", "Python", "Kubernetes", "Docker", "Terraform", "Helm", "CI/CD", "Linux"],
        "preferred_skills": ["Internal Developer Platforms (IDP)", "Backstage", "ArgoCD"],
        "tools": ["ArgoCD", "Helm", "Terraform", "Kubernetes", "Docker"],
        "frameworks": ["Backstage", "OpenTelemetry"],
