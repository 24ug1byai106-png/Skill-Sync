...
export default function CertificatesView() {
  const [certs, setCerts] = useState([
    { id: 1, name: "AWS_Certified_Developer_Associate.pdf", type: "PDF Document", issueDate: "2026-05-15", verified: true },
    { id: 2, name: "Docker_Kubernetes_Mastery_Certification.png", type: "PNG Image", issueDate: "2026-06-20", verified: true },
    { id: 3, name: "PostgreSQL_Database_Administration.pdf", type: "PDF Document", issueDate: "2026-07-10", verified: false }
  ]);
        ...
        {certs.map(c => (
          <div key={c.id} className="glass-panel" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Uploaded: {c.issueDate} • {c.type}</p>
            </div>
